...
$Control_Extend_identity = ($GLOBALS['Control_Category_identity'])($GLOBALS['Control_Category_categoryFn']);

// Control_Extend_Extend$Dict
$Control_Extend_Extend__dollar__Dict = (function() {
...
$Control_Extend_extendFn = (function() {
  $__fn = function($dictSemigroup) use (&$__fn) {
  $__num = func_num_args();
  if ($__num < 1) return phpurs_curry_fallback($__fn, func_get_args(), 1);
$append = ($GLOBALS['Data_Semigroup_append'])($dictSemigroup);
    $__res = ($GLOBALS['Control_Extend_Extend__dollar__Dict'])((object)["extend" => (function() use ($append) {
...
$Control_Extend_extendArray = ($GLOBALS['Control_Extend_Extend__dollar__Dict'])((object)["extend" => $GLOBALS['Control_Extend_arrayExtend'], "Functor0" => (function() {
  $__fn = function($__dollar____unused) use (&$__fn) {
  $__num = func_num_args();
  if ($__num < 1) return phpurs_curry_fallback($__fn, func_get_args(), 1);
...
$Control_Extend_extend = (function() {
...
$Control_Extend_extendFlipped = (function() {
  $__fn = function($dictExtend) use (&$__fn) {
  $__num = func_num_args();
  if ($__num < 1) return phpurs_curry_fallback($__fn, func_get_args(), 1);
$extend1 = ($GLOBALS['Control_Extend_extend'])($dictExtend);
...
$Control_Extend_duplicate = (function() {
  $__fn = function($dictExtend) use (&$__fn) {
  $__num = func_num_args();
  if ($__num < 1) return phpurs_curry_fallback($__fn, func_get_args(), 1);
    $__res = ($GLOBALS['Control_Extend_extend'])($dictExtend, $GLOBALS['Control_Extend_identity']);
  return $__num > 1 ? $__res(...array_slice(func_get_args(), 1)) : $__res;
  };
  return $__fn;
})();
...
$Control_Extend_composeCoKleisliFlipped = (function() {
  $__fn = function($dictExtend) use (&$__fn) {
  $__num = func_num_args();
  if ($__num < 1) return phpurs_curry_fallback($__fn, func_get_args(), 1);
$extend1 = ($GLOBALS['Control_Extend_extend'])($dictExtend);
...
$Control_Extend_composeCoKleisli = (function() {
  $__fn = function($dictExtend) use (&$__fn) {
  $__num = func_num_args();
  if ($__num < 1) return phpurs_curry_fallback($__fn, func_get_args(), 1);
$extend1 = ($GLOBALS['Control_Extend_extend'])($dictExtend);
