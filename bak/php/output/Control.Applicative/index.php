...
$Control_Applicative_Applicative__dollar__Dict = (function() {
...
$Control_Applicative_pure = (function() {
...
$Control_Applicative_unless = (function() {
...
if (($__case_0 === true)) {
return ($pure1)($GLOBALS['Data_Unit_unit']);
} else {
throw new \Exception("Pattern match failure");
};
};
...
$Control_Applicative_when = (function() {
  $__fn = function($dictApplicative) use (&$__fn) {
  $__num = func_num_args();
  if ($__num < 1) return phpurs_curry_fallback($__fn, func_get_args(), 1);
$pure1 = ($GLOBALS['Control_Applicative_pure'])($dictApplicative);
...
$Control_Applicative_liftA1 = (function() {
  $__fn = function($dictApplicative) use (&$__fn) {
  $__num = func_num_args();
  if ($__num < 1) return phpurs_curry_fallback($__fn, func_get_args(), 1);
$apply = ($GLOBALS['Control_Apply_apply'])((($dictApplicative)->Apply0)($GLOBALS['Prim_undefined']));
$pure1 = ($GLOBALS['Control_Applicative_pure'])($dictApplicative);
...
$Control_Applicative_applicativeProxy = ($GLOBALS['Control_Applicative_Applicative__dollar__Dict'])((object)["pure" => (function() {
...
$Control_Applicative_applicativeFn = ($GLOBALS['Control_Applicative_Applicative__dollar__Dict'])((object)["pure" => (function() {
...
$Control_Applicative_applicativeArray = ($GLOBALS['Control_Applicative_Applicative__dollar__Dict'])((object)["pure" => (function() {
  $__fn = function($x) use (&$__fn) {
  $__num = func_num_args();
  if ($__num < 1) return phpurs_curry_fallback($__fn, func_get_args(), 1);
    $__res = [$x];
