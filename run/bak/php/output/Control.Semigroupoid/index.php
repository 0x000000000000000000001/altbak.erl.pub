...
// ALL IMPORTS: Control.Semigroupoid, Prim
// TO REQUIRE: Control.Semigroupoid
...
\PhpursThunks::$thunks['Control_Semigroupoid_compose'] = function() { $v = function($dict) {
  $__num = \func_num_args();
  $__res = ($dict)->compose;
  goto __end;;
  __end:
...
\PhpursThunks::$thunks['Control_Semigroupoid_composeFlipped'] = function() { $v = (function() {
  $__fn = function($dictSemigroupoid, $f = null, $g = null) use (&$__fn) {
  $__num = \func_num_args();
  if ($__num < 3) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 3);
  }
  $__res = ((($dictSemigroupoid)->compose)($g))($f);
  goto __end;;
  __end:
...
\PhpursThunks::$thunks['Control_Semigroupoid_composeImpl'] = function() use (&$ffi_Control_Semigroupoid) { return $ffi_Control_Semigroupoid['composeImpl']; };
