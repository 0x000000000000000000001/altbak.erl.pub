...
\PhpursThunks::$thunks['Data_Unfoldable_fromJust'] = function() { $v = function($v) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Data_Unfoldable_unfoldr'] = function() { $v = function($dict) {
  $__num = \func_num_args();
  $__res = ($dict)->unfoldr;
  goto __end;;
  __end:
...
$__t1 = new Phpurs_Data1("Just", (($__local_var_0)->value0)->value0);
} else {
...
\PhpursThunks::$thunks['Data_Unfoldable_unfoldableArray'] = function() { $v = (object)["unfoldr" => ((((($GLOBALS['Data_Unfoldable_unfoldrArrayImpl'] ?? \PhpursThunks::eval('Data_Unfoldable_unfoldrArrayImpl')))(($GLOBALS['Data_Maybe_isNothing'] ?? \PhpursThunks::eval('Data_Maybe_isNothing'))))((($GLOBALS['Partial_Unsafe__unsafePartial'] ?? \PhpursThunks::eval('Partial_Unsafe__unsafePartial')))(function($dollar__unused_0) {
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
})))(($GLOBALS['Data_Tuple_fst'] ?? \PhpursThunks::eval('Data_Tuple_fst'))))(($GLOBALS['Data_Tuple_snd'] ?? \PhpursThunks::eval('Data_Tuple_snd'))), "Unfoldable10" => function($dollar__unused_0) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Data_Unfoldable_replicate'] = function() { $v = (function() {
  $__fn = function($dictUnfoldable, $n = null, $v = null) use (&$__fn) {
  $__num = \func_num_args();
  if ($__num < 3) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 3);
  }
  $__res = ((($dictUnfoldable)->unfoldr)(function($i) use (&$v) {
  $__num = \func_num_args();
...
$__t0 = new Phpurs_Data1("Just", new Phpurs_Data2("Tuple", $v, ((($GLOBALS['Data_Ring_intSub'] ?? \PhpursThunks::eval('Data_Ring_intSub')))($i))(1)));
};
  $__res = $__t0;
  goto __end;;
  __end:
...
\PhpursThunks::$thunks['Data_Unfoldable_replicateA'] = function() { $v = (function() {
  $__fn = function($dictApplicative, $dictUnfoldable = null, $dictTraversable = null) use (&$__fn) {
  $__num = \func_num_args();
  if ($__num < 3) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 3);
  }
  $sequence_0 = (($dictTraversable)->sequence)($dictApplicative);
  $__res = (function() use (&$dictUnfoldable, &$sequence_0) {
  $__fn = function($n, $m = null) use (&$dictUnfoldable, &$sequence_0, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__res = ($sequence_0)((((($GLOBALS['Data_Unfoldable_replicate'] ?? \PhpursThunks::eval('Data_Unfoldable_replicate')))($dictUnfoldable))($n))($m));
  goto __end;;
  __end:
  return $__num > 2 ? $__res(...\array_slice(\func_get_args(), 2)) : $__res;
  };
...
\PhpursThunks::$thunks['Data_Unfoldable_none'] = function() { $v = function($dictUnfoldable) {
  $__num = \func_num_args();
  $__res = ((($dictUnfoldable)->unfoldr)(function($v) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Data_Unfoldable_fromMaybe'] = function() { $v = function($dictUnfoldable) {
  $__num = \func_num_args();
  $__res = (($dictUnfoldable)->unfoldr)(function($b) {
  $__num = \func_num_args();
  if ((is_object($b) && (($b)->tag === "Just"))) {
$__t0 = new Phpurs_Data1("Just", new Phpurs_Data2("Tuple", ($b)->value0, new Phpurs_Data0("Nothing")));
} else {
$__t0 = new Phpurs_Data0("Nothing");
};
  $__res = $__t0;
