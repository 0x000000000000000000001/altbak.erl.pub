...
// ALL IMPORTS: Control.Alt, Data.Functor, Data.Semigroup, Prim
// TO REQUIRE: Control.Alt, Data.Functor, Data.Semigroup
...
\PhpursThunks::$thunks['Control_Alt_alt'] = function() { $v = function($dict) {
  $__num = \func_num_args();
  $__res = ($dict)->alt;
  goto __end;;
  __end:
