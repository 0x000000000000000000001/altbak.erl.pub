...
// ALL IMPORTS: Data.Function, Data.Ring, Data.Semiring, Data.Show, Effect, Effect.Console, Prelude, Prim, Test.Ackermann
// TO REQUIRE: Data.Function, Data.Ring, Data.Semiring, Data.Show, Effect, Effect.Console, Prelude, Test.Ackermann
...
\PhpursThunks::$thunks['Test_Ackermann_act'] = function() { $v = (($GLOBALS['Effect_Console_log'] ?? \PhpursThunks::eval('Effect_Console_log')))((($GLOBALS['Data_Show_showIntImpl'] ?? \PhpursThunks::eval('Data_Show_showIntImpl')))(((($GLOBALS['Test_Ackermann_ackermann'] ?? \PhpursThunks::eval('Test_Ackermann_ackermann')))(3))(4))); return $v; };
