...
\PhpursThunks::$thunks['Data_List_ZipList_ZipList'] = function() { $v = function($x) {
  $__num = \func_num_args();
  $__res = $x;
  goto __end;;
  __end:
...
\PhpursThunks::$thunks['Data_List_ZipList_showZipList'] = function() { $v = function($dictShow) {
  $__num = \func_num_args();
  $__res = (object)["show" => function($v) use (&$dictShow) {
  $__num = \func_num_args();
  $__res = ((($GLOBALS['Data_Semigroup_concatString'] ?? \PhpursThunks::eval('Data_Semigroup_concatString')))("(ZipList "))(((($GLOBALS['Data_Semigroup_concatString'] ?? \PhpursThunks::eval('Data_Semigroup_concatString')))((((($GLOBALS['Data_List_Lazy_Types_showList'] ?? \PhpursThunks::eval('Data_List_Lazy_Types_showList')))($dictShow))->show)($v)))(")"));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}];
...
\PhpursThunks::$thunks['Data_List_ZipList_ordZipList'] = function() { $v = function($dictOrd) {
  $__num = \func_num_args();
  $__res = (($GLOBALS['Data_List_Lazy_Types_ordList'] ?? \PhpursThunks::eval('Data_List_Lazy_Types_ordList')))($dictOrd);
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}; return $v; };
...
\PhpursThunks::$thunks['Data_List_ZipList_eqZipList'] = function() { $v = function($dictEq) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Data_List_ZipList_applyZipList'] = function() { $v = (object)["apply" => (function() {
  ...
  $__res = (((($GLOBALS['Data_List_Lazy_zipWith'] ?? \PhpursThunks::eval('Data_List_Lazy_zipWith')))(($GLOBALS['Data_Function_apply'] ?? \PhpursThunks::eval('Data_Function_apply'))))($v))($v1);
  goto __end;;
  __end:
...
\PhpursThunks::$thunks['Data_List_ZipList_zipListIsNotBind'] = function() { $v = function($dollar__unused_0) {
  $__num = \func_num_args();
  $__res = (object)["bind" => (($GLOBALS['Partial_Unsafe__unsafePartial'] ?? \PhpursThunks::eval('Partial_Unsafe__unsafePartial')))(function($dollar__unused_0) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Data_List_ZipList_altZipList'] = function() { $v = (object)["alt" => (function() {
  ...
  $__res = (((($GLOBALS['Data_List_Lazy_Types_semigroupList'] ?? \PhpursThunks::eval('Data_List_Lazy_Types_semigroupList')))->append)($v))(((($GLOBALS['Data_List_Lazy_drop'] ?? \PhpursThunks::eval('Data_List_Lazy_drop')))((($GLOBALS['Data_List_Lazy_length'] ?? \PhpursThunks::eval('Data_List_Lazy_length')))($v)))($v1));
  goto __end;;
  __end:
  return $__num > 2 ? $__res(...\array_slice(\func_get_args(), 2)) : $__res;
  };
