...
// ALL IMPORTS: Data.List, Data.List.Partial, Data.List.Types, Prim
// TO REQUIRE: Data.List, Data.List.Partial, Data.List.Types
...
$__t1 = ((($GLOBALS['Data_List_Partial_last'] ?? \PhpursThunks::eval('Data_List_Partial_last')))(($GLOBALS['Prim_undefined'] ?? \PhpursThunks::eval('Prim_undefined'))))(($v)->value1);
};
$__t0 = $__t1;
} else {
throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
...
$__t1 = new Phpurs_Data2("Cons", ($v)->value0, ((($GLOBALS['Data_List_Partial_init'] ?? \PhpursThunks::eval('Data_List_Partial_init')))(($GLOBALS['Prim_undefined'] ?? \PhpursThunks::eval('Prim_undefined'))))(($v)->value1));
};
$__t0 = $__t1;
} else {
throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
