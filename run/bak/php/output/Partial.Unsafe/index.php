...
namespace Partial\Unsafe;

// ALL IMPORTS: Partial, Partial.Unsafe, Prim
// TO REQUIRE: Partial, Partial.Unsafe
...
\PhpursThunks::$thunks['Partial_Unsafe_unsafeCrashWith'] = function() { $v = function($msg) {
  $__num = \func_num_args();
  $__res = (($GLOBALS['Partial_Unsafe__unsafePartial'] ?? \PhpursThunks::eval('Partial_Unsafe__unsafePartial')))(function($dollar__unused_0) use (&$msg) {
  $__num = \func_num_args();
  $__res = (($GLOBALS['Partial__crashWith'] ?? \PhpursThunks::eval('Partial__crashWith')))($msg);
  goto __end;;
  __end:
