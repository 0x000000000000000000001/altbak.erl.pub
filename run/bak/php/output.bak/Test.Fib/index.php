...
// ALL IMPORTS: Data.Function, Data.Ring, Data.Semiring, Data.Show, Effect, Effect.Console, Prelude, Prim, Test.Fib
// TO REQUIRE: Data.Function, Data.Ring, Data.Semiring, Data.Show, Effect, Effect.Console, Prelude, Test.Fib
...
\PhpursThunks::$thunks['Test_Fib_act'] = function() { $v = (($GLOBALS['Effect_Console_log'] ?? \PhpursThunks::eval('Effect_Console_log')))((($GLOBALS['Data_Show_showIntImpl'] ?? \PhpursThunks::eval('Data_Show_showIntImpl')))((($GLOBALS['Test_Fib_fib'] ?? \PhpursThunks::eval('Test_Fib_fib')))(10))); return $v; };
