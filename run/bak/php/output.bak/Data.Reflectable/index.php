...
// ALL IMPORTS: Data.Ord, Data.Reflectable, Prim, Type.Proxy
// TO REQUIRE: Data.Ord, Data.Reflectable, Type.Proxy
...
\PhpursThunks::$thunks['Data_Reflectable_reifiableString'] = function() { $v = (object)[]; return $v; };
\PhpursThunks::$thunks['Data_Reflectable_reifiableOrdering'] = function() { $v = (object)[]; return $v; };
...
\PhpursThunks::$thunks['Data_Reflectable_reifyType'] = function() { $v = (function() {
  $__fn = function($dollar__unused_0, $s = null, $f = null) use (&$__fn) {
  $__num = \func_num_args();
  if ($__num < 3) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 3);
  }
  $__res = (((($GLOBALS['Data_Reflectable_unsafeCoerce'] ?? \PhpursThunks::eval('Data_Reflectable_unsafeCoerce')))(function($dictReflectable) use (&$f) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Data_Reflectable_reflectType'] = function() { $v = function($dict) {
  $__num = \func_num_args();
  $__res = ($dict)->reflectType;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}; return $v; };
