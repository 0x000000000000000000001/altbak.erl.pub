...
\PhpursThunks::$thunks['Data_String_Regex_Flags_RegexFlags'] = function() { $v = function($x) {
  $__num = \func_num_args();
  $__res = $x;
  goto __end;;
  __end:
...
\PhpursThunks::$thunks['Data_String_Regex_Flags_showRegexFlags'] = function() { $v = (object)["show" => function($v) {
  $__num = \func_num_args();
  $usedFlags_0 = ((($GLOBALS['Data_Semigroup_concatArray'] ?? \PhpursThunks::eval('Data_Semigroup_concatArray')))([]))(((($GLOBALS['Data_Semigroup_concatArray'] ?? \PhpursThunks::eval('Data_Semigroup_concatArray')))(((($GLOBALS['Data_Functor_arrayMap'] ?? \PhpursThunks::eval('Data_Functor_arrayMap')))(function($v) {
  $__num = \func_num_args();
  $__res = "global";
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}))((($GLOBALS['Data_String_Regex_Flags_guard'] ?? \PhpursThunks::eval('Data_String_Regex_Flags_guard')))(($v)->global))))(((($GLOBALS['Data_Semigroup_concatArray'] ?? \PhpursThunks::eval('Data_Semigroup_concatArray')))(((($GLOBALS['Data_Functor_arrayMap'] ?? \PhpursThunks::eval('Data_Functor_arrayMap')))(function($v) {
  $__num = \func_num_args();
  $__res = "ignoreCase";
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}))((($GLOBALS['Data_String_Regex_Flags_guard'] ?? \PhpursThunks::eval('Data_String_Regex_Flags_guard')))(($v)->ignoreCase))))(((($GLOBALS['Data_Semigroup_concatArray'] ?? \PhpursThunks::eval('Data_Semigroup_concatArray')))(((($GLOBALS['Data_Functor_arrayMap'] ?? \PhpursThunks::eval('Data_Functor_arrayMap')))(function($v) {
  $__num = \func_num_args();
  $__res = "multiline";
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}))((($GLOBALS['Data_String_Regex_Flags_guard'] ?? \PhpursThunks::eval('Data_String_Regex_Flags_guard')))(($v)->multiline))))(((($GLOBALS['Data_Semigroup_concatArray'] ?? \PhpursThunks::eval('Data_Semigroup_concatArray')))(((($GLOBALS['Data_Functor_arrayMap'] ?? \PhpursThunks::eval('Data_Functor_arrayMap')))(function($v) {
  $__num = \func_num_args();
  $__res = "dotAll";
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}))((($GLOBALS['Data_String_Regex_Flags_guard'] ?? \PhpursThunks::eval('Data_String_Regex_Flags_guard')))(($v)->dotAll))))(((($GLOBALS['Data_Semigroup_concatArray'] ?? \PhpursThunks::eval('Data_Semigroup_concatArray')))(((($GLOBALS['Data_Functor_arrayMap'] ?? \PhpursThunks::eval('Data_Functor_arrayMap')))(function($v) {
  $__num = \func_num_args();
  $__res = "sticky";
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}))((($GLOBALS['Data_String_Regex_Flags_guard'] ?? \PhpursThunks::eval('Data_String_Regex_Flags_guard')))(($v)->sticky))))(((($GLOBALS['Data_Functor_arrayMap'] ?? \PhpursThunks::eval('Data_Functor_arrayMap')))(function($v) {
  $__num = \func_num_args();
  $__res = "unicode";
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}))((($GLOBALS['Data_String_Regex_Flags_guard'] ?? \PhpursThunks::eval('Data_String_Regex_Flags_guard')))(($v)->unicode))))))));
  if (((($GLOBALS['Data_String_Regex_Flags_eq'] ?? \PhpursThunks::eval('Data_String_Regex_Flags_eq')))($usedFlags_0))([])) {
$__t1 = "noFlags";
} else {
$__t1 = ((($GLOBALS['Data_Semigroup_concatString'] ?? \PhpursThunks::eval('Data_Semigroup_concatString')))("("))(((($GLOBALS['Data_Semigroup_concatString'] ?? \PhpursThunks::eval('Data_Semigroup_concatString')))(((($GLOBALS['Data_String_Common_joinWith'] ?? \PhpursThunks::eval('Data_String_Common_joinWith')))(" <> "))($usedFlags_0)))(")"));
};
  $__res = $__t1;
  goto __end;;
  __end:
...
\PhpursThunks::$thunks['Data_String_Regex_Flags_semigroupRegexFlags'] = function() { $v = (object)["append" => (function() {
  ...
  $__res = (object)["global" => ((($GLOBALS['Data_HeytingAlgebra_boolDisj'] ?? \PhpursThunks::eval('Data_HeytingAlgebra_boolDisj')))(($v)->global))(($v1)->global), "ignoreCase" => ((($GLOBALS['Data_HeytingAlgebra_boolDisj'] ?? \PhpursThunks::eval('Data_HeytingAlgebra_boolDisj')))(($v)->ignoreCase))(($v1)->ignoreCase), "multiline" => ((($GLOBALS['Data_HeytingAlgebra_boolDisj'] ?? \PhpursThunks::eval('Data_HeytingAlgebra_boolDisj')))(($v)->multiline))(($v1)->multiline), "dotAll" => ((($GLOBALS['Data_HeytingAlgebra_boolDisj'] ?? \PhpursThunks::eval('Data_HeytingAlgebra_boolDisj')))(($v)->dotAll))(($v1)->dotAll), "sticky" => ((($GLOBALS['Data_HeytingAlgebra_boolDisj'] ?? \PhpursThunks::eval('Data_HeytingAlgebra_boolDisj')))(($v)->sticky))(($v1)->sticky), "unicode" => ((($GLOBALS['Data_HeytingAlgebra_boolDisj'] ?? \PhpursThunks::eval('Data_HeytingAlgebra_boolDisj')))(($v)->unicode))(($v1)->unicode)];
  goto __end;;
  __end:
