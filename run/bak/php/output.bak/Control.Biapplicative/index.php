...
// ALL IMPORTS: Control.Biapplicative, Control.Biapply, Data.Tuple, Prim
// TO REQUIRE: Control.Biapplicative, Control.Biapply, Data.Tuple
...
\PhpursThunks::$thunks['Control_Biapplicative_bipure'] = function() { $v = function($dict) {
  $__num = \func_num_args();
  $__res = ($dict)->bipure;
  goto __end;;
  __end:
