...
// ALL IMPORTS: Control.Category, Control.Monad, Effect, Effect.Class, Prim
// TO REQUIRE: Control.Category, Control.Monad, Effect, Effect.Class
...
\PhpursThunks::$thunks['Effect_Class_liftEffect'] = function() { $v = function($dict) {
  $__num = \func_num_args();
  $__res = ($dict)->liftEffect;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}; return $v; };
