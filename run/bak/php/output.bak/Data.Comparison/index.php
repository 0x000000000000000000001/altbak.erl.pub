...
// ALL IMPORTS: Data.Comparison, Data.Function, Data.Functor.Contravariant, Data.Monoid, Data.Newtype, Data.Ord, Data.Ordering, Data.Semigroup, Prelude, Prim
// TO REQUIRE: Data.Comparison, Data.Function, Data.Functor.Contravariant, Data.Monoid, Data.Newtype, Data.Ord, Data.Ordering, Data.Semigroup, Prelude
...
\PhpursThunks::$thunks['Data_Comparison_Comparison'] = function() { $v = function($x) {
  $__num = \func_num_args();
  $__res = $x;
  goto __end;;
  __end:
...
\PhpursThunks::$thunks['Data_Comparison_semigroupComparison'] = function() { $v = (object)["append" => (function() {
  $__fn = function($v, $v1 = null, $x = null) use (&$__fn) {
  $__num = \func_num_args();
  if ($__num < 3) {
  ...
  $__local_var_0 = ($v)($x);
  $__local_var_1 = ($v1)($x);
  $__res = function($x) use (&$__local_var_0, &$__local_var_1) {
  $__num = \func_num_args();
  $__local_var_2 = ($__local_var_0)($x);
  $__local_var_3 = ($__local_var_1)($x);
...
\PhpursThunks::$thunks['Data_Comparison_defaultComparison'] = function() { $v = function($dictOrd) {
  $__num = \func_num_args();
