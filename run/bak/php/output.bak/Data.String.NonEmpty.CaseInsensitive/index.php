...
\PhpursThunks::$thunks['Data_String_NonEmpty_CaseInsensitive_CaseInsensitiveNonEmptyString'] = function() { $v = function($x) {
  $__num = \func_num_args();
  $__res = $x;
  goto __end;;
  __end:
...
\PhpursThunks::$thunks['Data_String_NonEmpty_CaseInsensitive_showCaseInsensitiveNonEmptyString'] = function() { $v = (object)["show" => function($v) {
  $__num = \func_num_args();
